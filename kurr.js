...
const dtod = "6281276698054@s.whatsapp.net"
const otod = "6281276698054@s.whatsapp.net"
// STICKER WM
...
AldiBotzKey = settings.AldiBotzkey
...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = kurr.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© AldiBotzゑ v.3.0_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             kurr.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = kurr.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/JI25LDtPW784GAZoRD9fW9', "groupName": `AldiBotzゑ v.3.0`, "footerText": "*_© AldiBotzゑ v.3.0_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© AldiBotzゑ v.3.0_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
...
//══════════[ GAME]══════════//
		...
		const reply = (teks) => {
			kurr.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdreply:{title: `${jmn} - ${week}  - ${calender}`,body:"AldiBotzゑ v.3.0",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/p/6349482305092740/6281276698054`}}})
		}
...
if(budy.includes('Dani')){
cpref = `Hayo Ngomongin Dani Official Ya Gw Bilangin Ah Aowkowk`
reply(cpref)
}
if(budy.includes('Assalamualaikum')){
cpref = `Waalaikumsalam Hay Saya Dani Botz Whatsapp Ketik .menu Untuk Mengakses`
reply(cpref)
}
if(budy.includes('assalamualaikum')){
cpref = `Waalaikumsalam Hay Saya Dani Botz Whatsapp Ketik .menu Untuk Mengakses`
...
cpref = `Hay Saya Dani Botz Whatsapp Ketik .menu Untuk Mengakses`
reply(cpref)
}
if(budy.includes('hai')){
cpref = `Hay Saya Dani Botz Whatsapp Ketik .menu Untuk Mengakses`
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_© AldiBotz_*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
reply('http://instagram.com/kurrsadboy')
}
if(isButton == 'ytm'){
reply('http://youtube.com/c/AldiBotz')
}
...
catat = await getBuffer(`https://api.zeks.me/api/nulis?text=${catat}&apikey=apivinz`)
   kurr.sendMessage(from, catat, image, { quoted:mek,caption:'Nih Ngab' })
   break
case 'nuliskiri': 
   if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
//══════════[ FITUR ASUPAN]══════════//
case 'hijaber':
asupan = await getBuffer(`https://apidhani.herokuapp.com/api/asupan/hijaber?apikey=NisaaCantik`)
kurr.sendMessage(from, asupan, image, {quoted: mek, caption: '_Nih Kak_'})
break
case 'bocil':
asupan = await getBuffer(`https://apidhani.herokuapp.com/api/asupan/bocil?apikey=NisaaCantik`)
kurr.sendMessage(from, asupan, image, {quoted: mek, caption: '_Nih Kak_'})
break
case 'rika':
asupan = await getBuffer(`https://apidhani.herokuapp.com/api/asupan/rikagusriani?apikey=NisaaCantik`)
kurr.sendMessage(from, asupan, video, {quoted: mek, caption: '_Nih Kak_'})
break
case 'santuy':
asupan = await getBuffer(`https://apidhani.herokuapp.com/api/asupan/santuy?apikey=NisaaCantik`)
kurr.sendMessage(from, asupan, video, {quoted: mek, caption: '_Nih Kak_'})
break
case 'ukhty':
asupan = await getBuffer(`https://apidhani.herokuapp.com/api/asupan/ukhty?apikey=NisaaCantik`)
kurr.sendMessage(from, asupan, video, {quoted: mek, caption: '_Nih Kak_'})
break
case 'ghea':
asupan = await getBuffer(`https://apidhani.herokuapp.com/api/asupan/gheayubi?apikey=NisaaCantik`)
kurr.sendMessage(from, asupan, video, {quoted: mek, caption: '_Nih Kak_'})
break
case 'chika':
...
//══════════[ FITUR CECAN]══════════//
case 'randomcecan':
cecan = await getBuffer(`https://apidhani.herokuapp.com/api/cecan/cecan?apikey=NisaaCantik`)
kurr.sendMessage(from, cecan, image, {quoted: mek, caption: '_Nih Kak_'})
break
case 'china':
cecan = await getBuffer(`https://apidhani.herokuapp.com/api/cecan/china?apikey=NisaaCantik`)
kurr.sendMessage(from, cecan, image, {quoted: mek, caption: '_Nih Kak_'})
break
case 'vietnam':
cecan = await getBuffer(`https://apidhani.herokuapp.com/api/cecan/vietnam?apikey=NisaaCantik`)
kurr.sendMessage(from, cecan, image, {quoted: mek, caption: '_Nih Kak_'})
break
case 'thailand':
cecan = await getBuffer(`https://apidhani.herokuapp.com/api/cecan/thailand?apikey=NisaaCantik`)
kurr.sendMessage(from, cecan, image, {quoted: mek, caption: '_Nih Kak_'})
break
case 'indonesia':
cecan = await getBuffer(`https://apidhani.herokuapp.com/api/cecan/indonesia?apikey=NisaaCantik`)
kurr.sendMessage(from, cecan, image, {quoted: mek, caption: '_Nih Kak_'})
break
case 'korea':
cecan = await getBuffer(`https://apidhani.herokuapp.com/api/cecan/korea?apikey=NisaaCantik`)
kurr.sendMessage(from, cecan, image, {quoted: mek, caption: '_Nih Kak_'})
break
case 'japan':
cecan = await getBuffer(`https://apidhani.herokuapp.com/api/cecan/japan?apikey=NisaaCantik`)
kurr.sendMessage(from, cecan, image, {quoted: mek, caption: '_Nih Kak_'})
break
case 'malaysia':
...
if (args.length < 1) return reply('*Teks nya mana?*')
                                        ...
                                        kurr.sendMessage(from, fku, text, {quoted: mek})
                                        break
case 'artinama':
				if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
case 'antibug':
          ...
          kurr.sendMessage(from, `ALLERT!!! Group ini sudah di pasang anti buggc\nJika Kamu Melanggar Maka Akan Saya Tendang`, text)
          } else if (args[0] === '0') {
          bugc = false
...
case 'quran':
			if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
				...
				kurr.sendMessage(from, quran, text, {quoted: mek})
				break
case 'hadist':
			if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
				anu = await fetchJson(`https://api.banghasan.com/quran/format/json/acak`, {method:'get'})
...
case 'kisahnabi':
			if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
				anu = await fetchJson(`https://apidhani.herokuapp.com/api/muslim/kisahnabi?nabi=muhammad&apikey=NisaaCantik`)
				quran = `${anu.acak.ar.teks}\n\n${anu.acak.id.teks}\nQ.S ${anu.surat.nama} ayat ${anu.acak.id.ayat}`
				kurr.sendMessage(from, kisahnabi, text, {quoted: mek})
				break
//══════════[ FITUR NSFW ]══════════//
case 'nsfwfutanari':
 if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
...
kurr.sendMessage(from, gambar, image, { quoted: ftrol })
})
break
case 'nsfwholoero':
 if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
...
case 'nsfwpussy':
					...
					kurr.sendMessage(from, buf, image, {quoted: mek,caption: "*INGAT ADA TUHAN KAK*"})
					})})
					} catch (e) {
...
kurr.sendMessage(from, oke, image, {quoted: mek, caption: '*Nih Kak Dah Jadi*'})
break
case 'hartatahta': 
if (args.length < 1) return reply(`*Teks nya mana?*\n_Contoh : ${prefix + command} namamu_`) 
teks = args.join(" ")
...
kurr.sendMessage(from, harta, image, {quoted: mek, caption: '*Nih Kak Dah Jadi*'})
break
...
kurr.sendMessage(from, pornhub, image, {caption: `*Nih kak dah jadi*`, quoted: mek})
break
case 'pornhub':
if (args.length < 1) return reply(`*Contoh : ${prefix + command} nama1&nama2*`)
var F = body.slice(8)
...
var F2 = F.split("&")[1]; 
reply(mess.wait)
anu = await fetchJson(`https://apidhani.herokuapp.com/api/other/aesthetic?apikey=NisaaCantik&text1=${F1}&text2=${F2}`)
pornhub = await getBuffer(anu.result)
kurr.sendMessage(from, pornhub, image, {caption: `*Nih kak dah jadi*`, quoted: mek})
break
case 'layered':
...
kurr.sendMessage(from, girlneko, image, {caption: `*Nih kak dah jadi*`, quoted: mek})
break
case 'sadboy':
if (args.length < 1) return reply(`*Contoh : ${prefix + command} nama1&nama2*`)
var F = body.slice(7)
...
kurr.sendMessage(from, ytmp4, video, {caption:`Done kak`, thumbnail:Buffer.alloc(0), quoted:mek})
break
case 'ytmp3':
if (args.length < 1) return reply("Masukkan url youtube")
url = args.join(' ')
...
kurr.sendMessage(from, ytmp3, audio, {mimetype:"audio/mp4", quoted:mek})
break
case 'joox':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
try{
...
oke = await getBuffer(`https://apidhani.herokuapp.com/api/anime/naruto?apikey=NisaaCantik`)
kurr.sendMessage(from, oke, image, {quoted: mek, caption: '_Nih Kak_'})
break
case 'waifu':
case 'neko':
...
case 'shota':
case 'wallml':
anu = await fetchJson(`https://apidhani.herokuapp.com/api/anime/${command}?apikey=NisaaCantik`)
loli = await getBuffer(anu.result)
kurr.sendMessage(from, loli, image, {quoted: mek, caption: '*Nih Kak*'})
break
//══════════[ RANDOM IMAGE ]══════════//
case 'ppcp':
case 'ppcouple':
...
kurr.sendMessage(from, buff1, image, {quoted: mek, caption: '_Nih kak cowoknya_'})
buff2 =await getBuffer (anu.result.female)
kurr.sendMessage(from, buff2, image, {quoted: mek, caption: '_Nih kak ceweknya_'})
break
case 'meme': 
reply(mess.wait)
anu = await fetchJson(`https://apidhani.herokuapp.com/api/random/meme?apikey=NisaaCantik`)
meme = await getBuffer(anu.result.url)
kurr.sendMessage(from, meme, image, {quoted: mek, caption: '*Nih Kak*'})
break
case 'wallpaperhacker':
case 'wallpaperharley':
case 'wallpaperjoker':
oke = await getBuffer(`https://apidhani.herokuapp.com/api/random/${command}?apikey=NisaaCantik`)
kurr.sendMessage(from, oke, image, {quoted: mek, caption: '_Nih Kak_'})
break
case 'quotesimage':
case 'renungan':
anu = await fetchJson(`https://apidhani.herokuapp.com/api/random/${command}?apikey=NisaaCantik`)
oke = await getBuffer(anu.result)
kurt.sendMessage(from, oke, image, {quoted: mek, caption: '_Nih Kak_'})
break
case 'darkjoker':
case 'darkjokes':
case 'darkjokers':
anu = await fetchJson(`https://apidhani.herokuapp.com/api/random/darkjokes?apikey=NisaaCantik`)
...
anu = await fetchJson(`https://apidhani.herokuapp.com/api/other/${command}?apikey=NisaaCantik`)
oke = await getBuffer(anu.result)
kurr.sendMessage(from, oke, image, {quoted: mek, caption: '_Nih Kak_'})
break
//══════════[ FITUR GROUP ]══════════//
...
if (!isGroup) return reply(mess.only.group)
if (!isBotGroupAdmins) return reply(mess.only.Badmin)
linkgc = await kur.groupInviteCode(from)
yeh = `https://chat.whatsapp.com/${linkgc}\n\nlink Group *${groupName}*`
kurr.sendMessage(from, yeh, text, { quoted: ftrol })
break
case 'promote' :
if (!isGroup) return reply(mess.only.group)
if (!isGroupAdmins && !mek.key.fromMe) return reply(mess.only.admin)
...
if (!isGroupAdmins) return reply(mess.only.admin)
if (!isBotGroupAdmins) return reply(mess.only.Badmin)
kurr.groupUpdateSubject(from, `${body.slice(9)}`)
kurr.sendMessage(from, `\`\`\`Sukses ✅, Mengganti nama grup menjadi\`\`\` *${body.slice(9)}*`, text, { quoted: ftrol })
break
case 'setdesc':
if (!isGroup) return reply(mess.only.group)
if (!isGroupAdmins) return reply(mess.only.admin)
if (!isBotGroupAdmins) return reply(mess.only.Badmin)
kurr.groupUpdateDescription(from, `${body.slice(9)}`)
kurr.sendMessage(from, `\`\`\`Sukses ✅, Mengganti deskripsi grup\`\`\` *${groupMetadata.subject}* Menjadi: *${body.slice(9)}*`, text, { quoted: ftrol })
break
case 'setppgrup':
case 'setpp':
if (!isGroup) return reply(mess.only.group)
...
kurr.updateProfilePicture(from, media)
...
if (!isGroup) return reply(mess.only.group)
try {
var pic = await kurr.getProfilePicture(from)
} catch {
var pic = 'https://i.ibb.co/Tq7d7TZ/age-hananta-495-photo.png'
}
let ingfo = `*G R O U P I N F O*\n\n*Name :* ${groupName}\n*ID Grup :* ${from}\n*Dibuat :* ${moment(`${groupMetadata.creation}` * 1000).tz('Asia/Jakarta').format('DD/MM/YYYY HH:mm:ss')}\n*Owner Grup :* @${groupMetadata.owner.split('@')[0]}\n*Jumlah Admin :* ${groupAdmins.length}\n*Jumlah Peserta :* ${groupMembers.length}\n*Welcome :* ${isWelkom ? 'Aktif' : 'Mati'}\n*AntiLink :* ${isAntiLink ? 'Aktif' : 'Mati'}\n*Desc :* \n\n${groupMetadata.desc}`
kurr.sendMessage(from, await getBuffer(pic), image, {quoted: mek, caption: ingfo, contextInfo: {"mentionedJid": [groupMetadata.owner.replace('@c.us', '@s.whatsapp.net')]}})
break
case 'resetlinkgc':
case 'resetlinkgroup':
case 'resetlinkgrup':
...
╭══─⊱ ❰ *_ᴜsᴇʀ ʙᴏᴛ ᴅᴀɴɪ_* ❱
├➤ ɴᴀᴍᴀ : ${pushname}
├➤ ɴᴏᴍᴏʀ : wa.me/6285773557984
├➤ Prefix : ${multi ? 'Multi Prefix' : 'No Prefix'}_
...
╭════━━⊱*「 𝗢𝗪𝗡𝗘𝗥 𝗠𝗘𝗡𝗨 」*      
║┣❏ *${prefix}autorespon* [ _on/off_ ]_
║┣❏ *${prefix}bc*
║┣❏ *${prefix}tobc*
║┣❏ *${prefix}return* [ _javascript_ ]_
║┣❏ *${prefix}delchat*
║┣❏ *${prefix}mute*
║┣❏ *${prefix}unmute*
║┣❏ *${prefix}public*
║┣❏ *${prefix}self*
║┣❏ *${prefix}spam* [ _teks|jumlah_ ]_
║┣❏ *${prefix}demoteall*
║┣❏ *${prefix}promoteall*
║┣❏ *${prefix}addcmd* [ _teks reply stc_ ]_
║┣❏ *${prefix}delcmd* [ _reply stc_ ]_
║┣❏ *${prefix}listcmd*
║┣❏ *${prefix}spamsw* [ _teks|jumlah_ ]_
║┣❏ *${prefix}upswteks* [ _teks_ ]_
║┣❏ *${prefix}upswlokasi* [ _teks_ ]_
║┣❏ *${prefix}upswaudio*
║┣❏ *${prefix}upswvoice*
║┣❏ *${prefix}upswsticker*
║┣❏ *${prefix}upswimage*
...
║┣❏ *${prefix}upswvideo*
║┣❏ *${prefix}shutdown*
║┣❏ *${prefix}offline* [ _alasan_ ]_
║┣❏ *${prefix}online*
║┣❏ *${prefix}exif* [ _nama|author_ ]_
║┣❏*${prefix}setprofile*
║┣❏*${prefix}setname* [ _teks_ ]
║┣❏*${prefix}setprefix *
║┣❏*${prefix}setbio* [ _teks_ ]_
║┣❏*${prefix}leave*
║┣❏*${prefix}restart*
║┣❏*${prefix}addrespon *
║┣❏*${prefix}delrespon* [ _nama_ ]_
║┣❏*${prefix}listrespon*
║┣❏*${prefix}readall*
║┣❏*${prefix}unreadall*
║┣❏*${prefix}archive*
...
║┣❏ *${prefix}antiwame* [ _on/off_ ]_
║┣❏ *${prefix} welcome* [ _on/off_ ]_
...
║┣❏ *${prefix}pinterest*
║┣❏ *${prefix}herolist*
║┣❏ *${prefix}herodetail* [ _hero_ ]_
║┣❏ *${prefix}google* [ _search_ ]_
║┣❏ *${prefix}gimage* [ _search_ ]_
║┣❏ *${prefix}wiki* [ _search_ ]_
║┣❏ *${prefix}mediafire* [ _link_ ]_
║┣❏ *${prefix}ytsearch* [ _judul_ ]_
║┣❏ *${prefix}ytmp4* [ _link yt_ ]_
║┣❏ *${prefix}ytmp3* [ _link yt_ ]_
║┣❏ *${prefix}play* [ _judul lagu_ ]_
║┣❏ *${prefix}video* [ _judul video_ ]_
║┣❏ *${prefix}tinyurl* [ _link_ ]_
║┣❏ *${prefix}fetch* [ _link_ ]_
║┣❏ *${prefix}igdl* [ _link_ ]_
║┣❏ *${prefix}tiktokdl* [ _link_ ]_
║┣❏ *${prefix}pinterest* [ _search_ ]_
║┣❏ *${prefix}lirik* [ _judul_ ]_
║┣❏ *${prefix}tourl* [ _reply image/video_ ]_
║┣❏ *${prefix}kalkulator* [ _angka_ ]_
║┣❏ *${prefix}translate* [ _teks kodebhs_ ]_
║┣❏ *${prefix}ss* [ _link_ ]_
║┣❏ *${prefix}playstore* [ _search_ ]_
║┣❏ *${prefix}tiktokaudio* [ _link_ ]_
║┣❏ *${prefix}brainly* [ _search_ ]_
║┣❏ *${prefix}igstory* [ _search_ ]_
║┣❏ *${prefix}igstalk* [ _link_ ]_
║┣❏ *${prefix}twitter* [ _link_ ]_
║┣❏ *${prefix}twmp3* [ _link_ ]_
║┣❏ *${prefix}linkwa* [ _search_ ]_
║┣❏ *${prefix}chara* [ _search_ ]_
║┣❏ *${prefix}otaku* [ _search_ ]_
║┣❏ *${prefix}komiku* [ _search_ ]_        
╰═══════════════❍*    
...
╭════━━⊱*「  𝗠𝗔𝗞𝗘𝗥 𝗠𝗘𝗡𝗨 」*    
║┣❏ *${prefix}gura* [ _text_ ]_   
║┣❏ *${prefix}kaneki* [ _text_ ]_   
║┣❏ *${prefix}girlneko* [ _text_ ]_   
║┣❏ *${prefix}rem* [ _text_ ]_  
║┣❏ *${prefix}sadboy* [ _text_ ]_    
║┣❏ *${prefix}dropwater* [ _text_ ]_       
║┣❏ *${prefix}pornhub* [ _text_ ]_    
║┣❏ *${prefix}wolf1* [ _text_ ]_
║┣❏ *${prefix}wolf2* [ _text_ ]_  
║┣❏ *${prefix}gradient* [ _text_ ]_
║┣❏ *${prefix}blackpink* [ _text_ ]_
║┣❏ *${prefix}naturalleaves* [ _text_ ]_
║┣❏ *${prefix}dropwater* [ _text_ ]_       
║┣❏ *${prefix}pornhub* [ _text_ ]_    
║┣❏ *${prefix}wolf1* [ _text_ ]_
║┣❏ *${prefix}wolf2* [ _text_ ]_  
║┣❏ *${prefix}gradient* [ _text_ ]_
║┣❏ *${prefix}blackpink* [ _text_ ]_
║┣❏ *${prefix}lolimaker* [ _text_ ]_
║┣❏ *${prefix}captainamerica* [ _text_ ]_
║┣❏ *${prefix}graffiti3* [ _text_ ]_
║┣❏ *${prefix}avengers* [ _text_ ]_
║┣❏ *${prefix}cinematichorror* [ _text_ ]_
║┣❏ *${prefix}marvel* [ _text_ ]_
║┣❏ *${prefix}marvel2* [ _text_ ]_
║┣❏ *${prefix}halloween* [ _text_ ]_
║┣❏ *${prefix}halloween2* [ _text_ ]_
║┣❏ *${prefix}ninjalogo* [ _text_ ]_
║┣❏ *${prefix}lionlogo[ _text_ ]_
║┣❏ *${prefix}realistic* [ _text_ ]_
║┣❏ *${prefix}3dsteel* [ _text_ ]_
║┣❏ *${prefix}glitch* [ _text_ ]_
║┣❏ *${prefix}glitch2* [ _text_ ]_
║┣❏ *${prefix}glitch3* [ _text_ ]_
║┣❏ *${prefix}8bit* [ _text_ ]_
║┣❏ *${prefix}hartatahta* [ _text_ ]_
║┣❏ *${prefix}3dgradient* [ _text_ ]_
║┣❏ *${prefix}blood* [ _text_ ]_
║┣❏ *${prefix}blood2* [ _text_ ]_
║┣❏ *${prefix}neon* [ _text_ ]_
║┣❏ *${prefix}neonlight* [ _text_ ]_
║┣❏ *${prefix}neonlight2* [ _text_ ]_
║┣❏ *${prefix}neonlight3* [ _text_ ]_
║┣❏ *${prefix}greenneon* [ _text_ ]_
║┣❏ *${prefix}toxic* [ _text_ ]_
║┣❏ *${prefix}matrix* [ _text_ ]_
║┣❏ *${prefix}thunder* [ _text_ ]_
║┣❏ *${prefix}bokeh* [ _text_ ]_
║┣❏ *${prefix}carbontext* [ _text_ ]_
║┣❏ *${prefix}christmas* [ _text_ ]_
║┣❏ *${prefix}breakwall* [ _text_ ]_
║┣❏ *${prefix}roadwarning* [ _text_ ]_
║┣❏ *${prefix}engraved3d* [ _text_ ]_
║┣❏ *${prefix}embossed* [ _text_ ]_
║┣❏ *${prefix}writefoggy* [ _text_ ]_
║┣❏ *${prefix}3dstone* [ _text_ ]_
║┣❏ *${prefix}futuristic* [ _text_ ]_
║┣❏ *${prefix}asketch* [ _text_ ]_
║┣❏ *${prefix}bluecircuit* [ _text_ ]_
║┣❏ *${prefix}space* [ _text_ ]_
║┣❏ *${prefix}amagmahot* [ _text_ ]_
║┣❏ *${prefix}artpapercut* [ _text_ ]_
║┣❏ *${prefix}3dluxurygold* [ _text_ ]_
║┣❏ *${prefix}harrypotter* [ _text_ ]_
║┣❏ *${prefix}greenhorrorstyle* [ _text_ ]_
║┣❏ *${prefix}3ddeepseametal* [ _text_ ]_
║┣❏ *${prefix}wonderfulgraffitiart* [ _text_ ]_
║┣❏ *${prefix}leddisplayscreen* [ _text_ ]_
╰═══════════════❍*  
 `
sendButLocation(from, `${menu}`, "*_© Dani Officialゑ v.3.0_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`menu`,buttonText:{displayText:'BACK TO MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
...
case 'memeindo':
  if (!isRegistered) return reply(`daftar dlu om/tante ketik .verify`)
              buff = await getBuffer(`https://api.zacros.my.id/randomimg/darkjokes`)
              buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await kurr.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'✗Dani Official✗', imageMessage: imageMsg,
              contentText:`Nih Om`,buttons,headerType:4}
...
├➤  『 USER INFO 』
│
├➤_Nama Bot : Dani Bot Assistan_
├➤_Nama Owner : ${NamaOwner}_
├➤_Nomor Owner : http://wa.me/6285773557984
...
├➤ _Nama : ${pushname}_
├➤ _Bio : ${stst}_
├➤ _Nomor : http://wa.me/6285773557984
│
└───「 Dani Bot Assistan 」    
╔═════════════════❍
║⸨𝐑𝐮𝐥𝐞𝐬 - 𝐒𝐢𝐦𝐩𝐥𝒆⸩
...
╚═════════════════❍ 
`
sendButLocation(from, `${menu}`, "*_© Dani Officialゑ v.3.0_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`store`,buttonText:{displayText:'STORE BOT'},type:1},{buttonId:`sewabot`,buttonText:{displayText:'SEWABOT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
...
╭══─⊱ ❰ *_ᴜsᴇʀ ʙᴏᴛ ᴅᴀɴɪ_* ❱ ⊰─═
├➤ ɴᴀᴍᴀ : ${pushname}
├➤ ɴᴏᴍᴏʀ : http://wa.me/6285773557984
├➤ Prefix : ${multi ? 'Multi Prefix' : 'No Prefix'}_
├➤ Mode : ${publik ? 'Public' : 'Self'}_
├➤ ᴜsᴇʀ ʀᴇɢɪsᴛᴇʀ : ${_registered.length}
╰──── ⸨ *_ᴅᴀɴɪ ʙᴏᴛ_* ⸩ ⊰─═══
...
ᴅᴀɴɪ ʙᴏᴛ
❏ *ᴋᴏɴᴛᴀᴋ ᴅᴀɴɪ:* 
http://wa.me/6285773557984
❏ *ɢʀᴜʙ ʙᴏᴛ ᴡᴀ:* 
https://chat.whatsapp.com/IN7mdbtdMTNFKpdALUsUC4
❏ *ᴄʜᴀɴɴᴇʟ ʏᴏᴜᴛᴜʙᴇ:* 
https://youtube.com/channel/UCVXEFV86XQNpDp7kqZqWQ4Q
  ----------------------------------
╔═════════════════❍
║⸨𝐑𝐮𝐥𝐞𝐬 - 𝐒𝐢𝐦𝐩𝐥𝒆⸩
║▬▭▬▭▬▭▬▭▬▭
...
case 'foliokanan':{
									...
									.on('exit', () => {
										kurr.sendMessage(from, fs.readFileSync('./media/nulis/images/folio/setelahkanan.jpg'), image, {thumbnail:Buffer.alloc(0),quoted: mek, caption: `Jangan Malas`})
									})
									}
									break
case 'bego':
...
case 'catlog': 
  if (!isRegistered) return reply(`daftar dlu om/tante ketik .verify`)
                ...
                nama = ' ゑwelcome to Dani Officialゑ '
       ownerJid = "6285773557984@s.whatsapp.net"
                nomor = 1
                stod = `${sender}`
       stst = await kurr.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
       menunya =`*Dani Official Melayani Jasa Pembuatan Vps/Rdp* 
...
case 'verify':
case 'daftar':
if (isRegistered) return reply(`Ok Om/Tante`)
...
ini_list.push({
"displayName": `Developer DaniBotzゑ v.3.0`,
...
MINAT HUB https://wa.me/6285773557984/?text=.sewabot
...
case 'payment':
dona = fs.readFileSync('./media/donasi.jpg')
doni =`*╭─❒ 「 AldiBotz PAYMENT 」 ──────*
*│*
*│*⬡ *PEMBAYARAN BISA VIA*
*│*⬡ *DANA   : 081915460158
*│*⬡ *GOPAY/OVO/SHOPEEPAY    : Scan Aja Kode Kode Di Atas*
*└───────────────────*
Scan QR di atas bila belum premium`
kurr.sendMessage(from, dona, image, { quoted: ftrol, thumbnail: dona, caption: doni })
break
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `Script Dani Officialゑ v.3.0`,
          "url": "https://github.com/RIMURUBOTZ"
        },
        "index": 0
      }
    ]
...
case 'blackpink':
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    if (args.length == 0) return reply(`Example: ${prefix + command} Dani Botz`)
                    ini_txt = args.join(" ")
                    getBuffer(`https://api-alphabot.herokuapp.com/api/textpro/blackpink? text=&apikey=Alphabot&text=${ini_txt}`).then((gambar) => {
                        kurr.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Subrek yt : Dani Ofc`, quoted : ftrol})
                    })
                    break
case 'neon':
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    if (args.length == 0) return reply(`Example: ${prefix + command} Dani Botz`)
                    ini_txt = args.join(" ")
                    getBuffer(`https://api.xteam.xyz/textpro/neon?text=Xteam&APIKEY=546fd166f15b8149&text=${ini_txt}`).then((gambar) => {
                        kurr.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Subrek yt : Dani Ofc`, quoted : ftrol})
                    })
                    break
                case 'pornhub':
                ...
                case 'wallgravity':
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    if (args.length == 0) return reply(`Example: ${prefix + command} aldi Botz`)
                    txt1 = args[0]
                    txt2 = args[1]
                    getBuffer(`https://api.lolhuman.xyz/api/textprome2/${command}?apikey=${lolkey}&text1=${txt1}&text2=${txt2}`).then((gambar) => {
                        kurr.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Subrek yt : AldiBotz`, quoted : ftrol})
                    })
                    break
//══════════[ FITUR POOTOXY]══════════//
                case 'shadow':
...
if (tebakgambar.hasOwnProperty(sender.split('@')[0])) return reply("Selesein yg sebelumnya dulu atuh")
  get_result = await fetchJson(`https://xteam.xyz/game/tebakgambar?APIKEY=546fd166f15b8149`)
...
break
       ...
       if (!isRegistered) return reply(`daftar dlu om/tante ketik .verify`)
              ...
              get_result = await fetchJson(`https://apidhani.herokuapp.com/api/game/caklontong?apikey=NisaaCantik`)
              get_result = get_result.result
              jawaban = get_result.answer
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
...
if (!isOwner && !mek.key.fromMe) return reply(`Khusus Owner Om`)
  if (args.length < 1) return reply('Teksnya?')
                    teks = body.slice(12)
                    kurr.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`AldiBotzゑ v.3.0`}, MessageType.location)
...
Link : ${get_resultP.audio}
            ...
            "sourceUrl": "http://AldiBotzstore.xyz"
...
Giliran = @${tty.player1.split('@')[0]}`
 kurr.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     kurr.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdreply:{title: "Developer AldiBotzゑ v.3.0",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./logonya.jpeg'),sourceUrl:"https://wa.me/p/6349482305092740/6281276698054"}}})
	}
    }
    }
    }
